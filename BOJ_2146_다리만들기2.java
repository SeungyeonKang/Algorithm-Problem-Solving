...
/* 각각의 섬을 dfs를 이용해 다르게 숫자를 붙여주고, 
 * bfs를 통해 섬을 확장하며 bridge 배열에 필요한 다리 길이를 저장한다.
 * 섬을 모두 확장하면 바다가 없어지므로 섬끼리 인접하게 된다.
 * 섬끼리 인접한 부분의 bridge 값을 더해서 가장 작은 값이 가장 짧은 다리 길이가 된다.
 */
